...
class Reasoner(nn.Module):
    """IR-Reasoner block adapted from YOLOv7-Reasoner. Applies spatial self-attention on a feature map and returns a
    refined fetures map with residual connection.
    """
